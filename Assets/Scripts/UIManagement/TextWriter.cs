...
public class TextWriter : MonoBehaviour
{
    ...
    [System.NonSerialized] public static TextWriter instance;
    ...
    public void WriteText(TextMeshProUGUI dialogText, string textToWrite, float timePerCharacter, bool invisibleCharacters)
    {
        textWriterSingleList.Add(new TextWriterSingle(dialogText, textToWrite, timePerCharacter, invisibleCharacters));
    }

    public void RemoveWriter(TextMeshProUGUI dialogueText)
    {
